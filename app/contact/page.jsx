  ...
  return (
    <section className=" overflow-hidden">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-body text-center text-pretty text-black text-[18px]">
          Heb je een technisch probleem? Wil je feedback geven over de app? Meer
          weten over ons de KNMI? Laat het ons weten.
        </p>
        <form action="#" className="space-y-8">
          <div>
            <label
              htmlFor="email"
              className="block mb-2 text-sm font-body font-medium text-gray-900"
            >
              Jouw e-mail
            </label>
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-body font-medium text-center text-wit rounded-full bg-groen sm:w-fit hover:bg-groendark focus:ring-4 focus:outline-none focus:ring-primary-300"
          >
            Bericht versturen
          </button>
        </form>
