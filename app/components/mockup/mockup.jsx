  ...
  return (
    <main>
      <div className="py-10 px-4 mx-auto max-w-screen-xl lg:py-10 lg:px-6 text-center">
        <h1 className="mt-10 mb-10 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl font-heading">
          Met de KNMI-app ben je voorbereid op <br /> gevaarlijk weer
        </h1>
        <p className="mb-10 text-[16px] font-normal text-gray-500 sm:px-16 xl:px-48 font-body">
